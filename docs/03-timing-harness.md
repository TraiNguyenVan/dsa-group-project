...
**JIT caveat:** Java/JS run 1 is slow (interpreted). Until the planned 3 discarded warmup runs are added, compare `min(best)` or `mean(runs 2–5)` for those languages. See [08 — Interpreting Results](08-interpreting-results.md).

---

Next: [04 — Benchmark Modes](04-benchmark-modes.md) — interactive vs batch.
